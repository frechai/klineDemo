...
- (void)pushAnimateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    UIViewController<TransitionProtocol> * fromVC = (UIViewController <TransitionProtocol> * )[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    UIViewController<TransitionProtocol> * toVC = (UIViewController <TransitionProtocol> * )[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
    //from和to的两个视图
    ...
    [UIView animateWithDuration:self.animationDuration animations:^{
        ...
        //YAppDelegate.mainTabBar.tabBar.alpha = 0;
...
- (void)popAnimateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    [UIView animateWithDuration:self.animationDuration animations:^{
        ...
        //YAppDelegate.mainTabBar.tabBar.alpha = 1;
    } completion:^(BOOL finished) {
        //        if (finished) {
